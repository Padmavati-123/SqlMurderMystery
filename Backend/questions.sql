...
(1, 'What does the SELECT * FROM table_name; command do?', 
    'Selects all records from the table', 
    'Selects only the first record from the table', 
    'Selects only unique records from the table', 
    'Selects a specific column from the table', 
    1),

(1, 'What does the following query do? SELECT name FROM students;', 
    'Selects all columns from the students table', 
    'Selects only the name column from the students table', 
    'Deletes the name column from the students table', 
    'Inserts a new column named name into the students table', 
    2),

(1, 'What happens if you execute SELECT NULL; in MySQL?', 
    'Returns an error', 
    'Returns NULL', 
    'Returns 0', 
...
(1, 'What will be the result of the following query? SELECT 10 + 5;', 
    'An error because there is no table', 
    'Returns 15', 
    'Returns 10+5 as a string', 
    'Returns NULL', 
    2),
(2, 'What is the primary function of the FROM clause in an SQL query?', 
...
(2, 'What happens if the FROM clause specifies a non-existent table?', 
    'The query executes with a warning', 
    'The query returns an empty result set', 
    'The query returns NULL values', 
    'The query results in an error', 
    4),

(2, 'Which of the following statements correctly uses the FROM clause?', 
...
(2, 'What will happen if the FROM clause is missing in a SELECT statement?', 
    'MySQL throws a syntax error', 
    'MySQL still executes if selecting a constant value', 
    'MySQL automatically selects from a default table', 
    'MySQL replaces it with FROM dual', 
    2),

(2, 'What does this query do? SELECT \'Hello World\' FROM employees;', 
    'Returns \'Hello World\' once', 
    'Returns \'Hello World\' for each row in employees', 
    'Throws an error because \'Hello World\' is not a column', 
    'Returns NULL', 
    2),

(3, 'What is the purpose of the WHERE clause in MySQL?', 
...
(3, 'Which of the following SQL queries retrieves all employees who work in the IT department?', 
    'SELECT * FROM employees WHERE department = "IT";', 
    'SELECT IT FROM employees;', 
    'SELECT department FROM employees WHERE IT;', 
    'SELECT * FROM employees GROUP BY department;', 
    1),

(3, 'What will happen if you use a WHERE clause without a condition?', 
    'MySQL will return an error', 
    'It will return all rows from the table', 
    'It will delete all rows from the table', 
    'It will return only the first row', 
    1),
(3, 'What does this query do? SELECT * FROM products WHERE price < 100;', 
    'Selects products that cost exactly 100', 
    'Selects products that cost more than 100', 
    'Selects products that cost less than 100', 
    'Selects products with no price', 
    3),

(3, 'Which keyword is used with WHERE to check multiple conditions?', 
    'AND', 
    'OR', 
    'BOTH', 
    'JOIN', 
...
(4, 'What is the default sorting order when using ORDER BY?', 
    'Ascending (ASC)', 
    'Descending (DESC)', 
    'Random order', 
...
(4, 'Which keyword is used to sort results in descending order?', 
    'DESC', 
    'DOWN', 
    'ORDER DOWN', 
    'SORT DESC', 
...
(4, 'How can you sort by multiple columns?', 
    'ORDER BY column1 AND column2', 
    'ORDER BY column1, column2', 
    'SORT BY column1 THEN column2', 
    'GROUP BY column1, column2', 
    2),

(4, 'What happens when ORDER BY is applied to a text column?', 
...
(12, 'What does the COUNT() function do in SQL?', 
    ...
    'Counts all rows except NULL values', 
    'Counts only NULL values', 
    'Counts distinct values only', 
    2),

(12, 'What will COUNT(*) return?', 
...
(12, 'Which query correctly counts the number of employees in the "employees" table?', 
    'SELECT COUNT(salary) FROM employees;', 
...
(12, 'What does COUNT(NULL) return?', 
    '0', 
    '1', 
    'NULL', 
...
(12, 'What happens if you use COUNT() without specifying a column?', 
    'Counts all rows including NULL values', 
    'Throws an error', 
    'Counts only NULL values', 
    'Counts distinct values', 
    1),
(18, 'What does an INNER JOIN do?', 
    'Returns only matching records from both tables', 
    'Returns all records from both tables', 
    'Returns unmatched records only', 
    'Returns only NULL values', 
    1),

(18, 'What is required for an INNER JOIN to work?', 
    'A common column between tables', 
    'Both tables must have the same number of rows', 
    'Tables must have the same column names', 
    'Tables must be identical', 
    1),

(18, 'Which statement correctly performs an INNER JOIN between employees and departments?', 
    'SELECT * FROM employees INNER JOIN departments;', 
    'SELECT * FROM employees JOIN departments ON employees.dept_id = departments.id;', 
    'SELECT employees INNER JOIN departments;', 
    'SELECT employees, departments;', 
    2),

(18, 'What happens if there are no matching rows in an INNER JOIN?', 
...
(18, 'Can INNER JOIN be used with multiple tables?', 
    'Yes', 
    'No', 
    'Only with two tables', 
    'Only with identical tables', 
    1),
(21, 'What does the INSERT INTO statement do?', 
...
(21, 'Which statement correctly inserts a new row?', 
    'INSERT INTO employees VALUES ("John", 50000);', 
    'INSERT INTO employees (name, salary) VALUES ("John", 50000);', 
    'ADD TO employees VALUES ("John", 50000);', 
    'INSERT employees ("John", 50000);', 
    2),

(21, 'Can you insert data into a table without specifying column names?', 
    'Yes, if values match all columns', 
    'No', 
    'Only with an alias', 
    'Only with a WHERE clause', 
    1),

(21, 'What happens if you omit a NOT NULL column in an INSERT?', 
    'An error occurs', 
    'NULL is inserted', 
