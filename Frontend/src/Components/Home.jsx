...
// import { FaUserCircle, FaDatabase, FaGamepad, FaEnvelope, FaPhoneAlt, FaQuestionCircle } from "react-icons/fa";
...
//         }}>
//             {/* Navbar */}
//             <nav className="bg-black bg-opacity-70 backdrop-blur-md shadow-lg p-4 flex justify-between items-center px-6 border-b border-red-700">
//                 <h1 className="text-3xl font-bold text-yellow-400 tracking-wide">🕵️ SQL Murder Mystery</h1>
//                 <div className="flex space-x-6">
//                     <button onClick={() => navigate("/about")} className="hover:text-red-400 transition font-semibold">About</button>
//                     <button onClick={() => navigate("/faqs")} className="hover:text-red-400 transition font-semibold flex items-center gap-2">
//                         <FaQuestionCircle /> FAQs
//                     </button>
//                     <button onClick={() => navigate("/contact")} className="hover:text-red-400 transition font-semibold">Contact Us</button>
//                     <div className="relative">
//                         <button
//                             onClick={() => setShowDropdown(!showDropdown)}
//                             className="flex items-center gap-2 hover:text-red-400 transition font-semibold"
//                         >
//                             <FaUserCircle className="text-xl" />
//                             {user ? user.name : "My Account"}
//                         </button>
//                         {showDropdown && user && (
//                             <div className="absolute right-0 mt-2 w-48 bg-gray-800 bg-opacity-80 shadow-md rounded-lg p-3 border border-gray-600">
//                                 <p className="text-sm text-gray-300">👤 {user.name}</p>
//                                 <p className="text-sm text-gray-300">📧 {user.email}</p>
//                                 <button
//                                     className="mt-3 bg-red-600 w-full py-1 rounded-md hover:bg-red-700 transition"
...
//                 <h1 className="text-4xl font-extrabold mb-6 text-red-700">
//                     <Typewriter
//                         options={{
//                             strings: ["Welcome to the SQL Crime Scene!", "Are you ready to solve the mystery?"],
//                             autoStart: true,
//                             loop: true,
//                         }}
//                     />
...
//                     <div
//                         className="bg-gray-800 bg-opacity-90 backdrop-blur-md text-white p-6 rounded-lg shadow-lg border border-red-600 transform hover:scale-105 transition duration-300 cursor-pointer"
//                         onClick={() => navigate("/topics")}
//                     >
//                         <h2 className="text-xl font-semibold flex items-center gap-2">
//                             <FaDatabase className="text-blue-400" /> Learn SQL
//                         </h2>
...
//                     >
//                         <h2 className="text-xl font-semibold flex items-center gap-2">
//                             <FaGamepad className="text-green-400" /> SQL Game
//                         </h2>
...
//                     <a href="mailto:contact@sqlmystery.com" className="flex items-center gap-2 text-gray-400 hover:text-yellow-400 transition">
//                         <FaEnvelope /> contact@sqlmystery.com
//                     </a>
//                     <span className="text-gray-400">|</span>
//                     <a href="tel:+123456789" className="flex items-center gap-2 text-gray-400 hover:text-yellow-400 transition">
